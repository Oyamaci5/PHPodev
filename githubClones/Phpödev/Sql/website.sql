...
--
-- Anamakine: 127.0.0.1
-- Üretim Zamanı: 10 Oca 2022, 11:26:18
...
--
-- Tablo için tablo yapısı `citeurl`
--

CREATE TABLE `citeurl` (
  `id` int UNSIGNED NOT NULL,
  `CiteName` varchar(255) NOT NULL,
  `Citelink` varchar(255) NOT NULL
...
--
-- Tablo için AUTO_INCREMENT değeri `citeurl`
--
ALTER TABLE `citeurl`
